...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['login'])) {
    ...
    if ($result === true) {
        header("Location: Podminky.php"); // Přesměrování na aktuální stránku
        exit();
    } else {
...
<head>
    ...
    <title>BezvaTábor - Informace pro rodiče</title>
...
<footer class="footer">
 ...
 <div class="login-form-container" id="loginForm">
    <form action="Podminky.php" method="POST">
...
<!-- Registrační formulář -->
    <div class="register-form-container" id="registerForm">
        <form action="Podminky.php" method="POST" onsubmit="return kontrolaUsername();">
